            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card data-testid="card-schools-list">
                <CardHeader>
                  ...
                  <CardDescription>K-12 schools in the system</CardDescription>
                </CardHeader>
                <CardContent>
                  {schoolsLoading ? (
                    ...
                    <div className="space-y-3">
                      {schools.map((school) => (
                        <div key={school.id} className="p-3 border rounded-md hover-elevate" data-testid={`school-item-${school.id}`}>
