    ...
    <div className="h-full overflow-auto">
      ...
      <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white p-6">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3">
          ...
          <Progress value={(userStats.points / 3000) * 100} className="h-2 bg-white/20" />
          <p className="text-xs text-blue-100 mt-1">580 pts to Level {userStats.level + 1}</p>
        </div>
      </div>
            ...
            <Card key={index} className="p-3">
              ...
              {cert.status === 'Earned' ? (
                ...
                <>
                  ...
                  <p className="text-xs text-slate-600">{cert.progress}% complete</p>
                </>
              ) : (
